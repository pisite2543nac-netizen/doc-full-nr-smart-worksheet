...
export default function SetupPage() {
  ...
  async function install(event) {
    ...
    try {
      ...
      setMessage(
        "✅ สร้าง/ตรวจสอบ Admin และตั้งค่าระบบสำเร็จ โดยไม่แก้ไขข้อมูลรายวิชาที่มีอยู่"
      );
    ...
    <div className="page-center">
      ...
      >
        ...
        <div className="notice">
          ระบบจะสร้าง/ตรวจสอบ Admin และ systemSettings เท่านั้น
          ข้อมูลรายวิชาที่มีอยู่ใน Firestore จะไม่ถูกลบหรือเขียนทับ
